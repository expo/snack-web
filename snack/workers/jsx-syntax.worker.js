/**
 * Monaco doesn't syntax highlight JSX. This allows us to properly syntax highlight JSX code.
...
self.addEventListener('message', event => {
  ...
  try {
    ...
    const sourceFile = self.ts.createSourceFile(title, code, self.ts.ScriptTarget.ES6, true);
